    ...
    public partial class Form1 : Form, GraphEventCallback
    {
        ...
        protected override void WndProc(ref Message m)
        {
            switch (m.Msg)
            {
                ...
                case WM_GRAPH_EVENT:
                    {
                        if (m_pPlayer.State()==PlaybackState.Running)
                        {
                            m_pPlayer.HandleGraphEvent(this);
                        }
                        if (m_pPlayer1.State() == PlaybackState.Running)
                        {
                            m_pPlayer1.HandleGraphEvent(this);
                        }
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                //new Guid("1643E180-90F5-11CE-97D5-00AA0055595A")
